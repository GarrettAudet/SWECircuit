...
export const DIAGNOSTIC_DEFINITIONS = Object.freeze({
  ...
  SC4401: definition(
    "specialist.run.session-invalid",
    "error",
    2,
    "A specialist run session is invalid or does not match its verified package.",
    "Restore only a closed canonical session bound to the exact approved compilation and package.",
  ),
  SC4402: definition(
    "specialist.run.limit-exceeded",
    "error",
    2,
    "A specialist run value exceeds a declared raw or canonical size limit.",
    "Split the run or reduce the package, handoff, session, or inspection size.",
  ),
  SC4403: definition(
    "specialist.run.handoff-conflict",
    "error",
    2,
    "A different handoff was submitted for an already settled specialist agent.",
    "Preserve the first exact handoff and route conflicting evidence for external review.",
  ),
  SC4404: definition(
    "specialist.run.handoff-premature",
    "error",
    2,
    "A specialist handoff was submitted before every transitive dependency accepted pass.",
    "Record every required passing dependency handoff before this specialist handoff.",
  ),
  SC4405: definition(
    "specialist.run.session-routed",
    "error",
    2,
    "A new specialist handoff was submitted after the session routed a non-pass outcome.",
    "Route the accepted specialist outcome through the external integration owner.",
  ),
  SC4501: definition(
    "runtime.routing.schema-invalid",
    "error",
    2,
    "The runtime-routing input does not match the closed v1alpha1 contract.",
    "Use only the documented runtime-routing fields and values.",
  ),
  SC4502: definition(
    "runtime.routing.limit-exceeded",
    "error",
    2,
    "A runtime-routing value exceeds a published count or byte limit.",
    "Reduce the policy, inventory, calibration, blueprint, evidence, or search input.",
  ),
  SC4503: definition(
    "runtime.routing.demand-policy-invalid",
    "error",
    2,
    "The runtime demand policy is incomplete, ambiguous, or internally contradictory.",
    "Cover every declared capability and tier with one deterministic owner-authored rule.",
  ),
  SC4504: definition(
    "runtime.routing.supply-binding-invalid",
    "error",
    2,
    "The runtime calibration or host inventory binding is invalid.",
    "Use current, uniquely identified profile and effort rows with exact capability bindings.",
  ),
  SC4505: definition(
    "runtime.routing.specialist-binding-invalid",
    "error",
    2,
    "A specialist blueprint, evidence duty, or independence relationship is invalid.",
    "Reconstruct the approved specialist compilation and preserve its exact relationships.",
  ),
  SC4506: definition(
    "runtime.routing.no-feasible-vector",
    "error",
    2,
    "No runtime assignment vector satisfies every hard gate.",
    "Revise supply, calibration, demand, or owner policy without weakening hidden constraints.",
  ),
  SC4507: definition(
    "runtime.routing.bounded-search-empty",
    "error",
    2,
    "Bounded runtime search found no feasible evaluated assignment vector.",
    "Increase the bounded evaluated set within published limits or revise the declared inputs.",
  ),
  SC4508: definition(
    "runtime.routing.override-invalid",
    "error",
    2,
    "A runtime assignment override is invalid or makes the complete vector infeasible.",
    "Choose an available row that preserves all global hard gates and record the owner rationale.",
  ),
  SC4509: definition(
    "runtime.routing.expectation-mismatch",
    "error",
    2,
    "The runtime assignment compilation does not match the trusted expectation.",
    "Use the exact approved policy, calibration, inventory, specialist, and compilation digests.",
  ),
  SC4510: definition(
    "runtime.routing.digest-mismatch",
    "error",
    2,
    "A runtime-routing digest or canonical identity does not match its content.",
    "Recompile from preserved canonical inputs and discard the mismatched artifact.",
  ),
  SC4601: definition(
    "adaptive.run.schema-invalid",
    "error",
    2,
    "The adaptive-run input does not match the closed v1alpha1 contract.",
    "Use only the documented adaptive session, expectation, host event, inspection, and RunView fields.",
  ),
  SC4602: definition(
    "adaptive.run.limit-exceeded",
    "error",
    2,
    "An adaptive-run value exceeds a published count or byte limit.",
    "Reduce the host event, evidence, lineage, session, inspection, or RunView input.",
  ),
  SC4603: definition(
    "adaptive.run.expectation-mismatch",
    "error",
    2,
    "The adaptive run does not match its trusted assignment, package, session, host, or adapter expectation.",
    "Use exact externally approved identities and reconstruct the candidate before continuing.",
  ),
  SC4604: definition(
    "adaptive.run.transition-invalid",
    "error",
    2,
    "A host event is invalid for the current adaptive lifecycle state.",
    "Emit only a dependency-eligible, route-valid transition for the exact active attempt.",
  ),
  SC4605: definition(
    "adaptive.run.event-conflict",
    "error",
    2,
    "A host event is stale, duplicated, or conflicts with the accepted raw event chain.",
    "Preserve the first accepted event and diagnose any competing or out-of-order observation.",
  ),
  SC4606: definition(
    "adaptive.run.materialization-mismatch",
    "error",
    2,
    "A runtime materialization binding is unavailable, widened, or different from the approved assignment.",
    "Block the launch or create a new approved assignment; never use a hidden fallback.",
  ),
  SC4607: definition(
    "adaptive.run.result-binding-invalid",
    "error",
    2,
    "A result capture or specialist handoff does not match the authorized launch and package.",
    "Preserve exact raw bytes and verify every assignment, event, blueprint, package, and evidence binding.",
  ),
  SC4608: definition(
    "adaptive.run.restore-invalid",
    "error",
    2,
    "An adaptive restore source or digest is invalid.",
    "Restore only exact canonical session bytes bound to the trusted expectation.",
  ),
  SC4609: definition(
    "adaptive.run.terminal",
    "error",
    2,
    "The adaptive run is terminal and cannot accept another event.",
    "Route the terminal outcome or create an explicit successor run.",
  ),
  SC4610: definition(
    "adaptive.run.successor-invalid",
    "error",
    2,
    "Adaptive successor lineage is invalid or exceeds its bounded depth.",
    "Bind one valid predecessor, route reason, revision, and digest within the published lineage limit.",
  ),
  SC5001: definition(
