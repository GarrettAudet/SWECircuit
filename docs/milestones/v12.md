...
V12 is not merge-ready. Candidate-addressed external evidence records that Revision 62 passed its corrected exact lifecycle but failed the complete verifier and all seven hosted jobs after an R62-only binary attribute changed V11's authenticated `.gitattributes` identity; its one-shot gate remains unused and the source is retired. Revision 63 removes only that attribute, preserves the R61 evidence bytes, and passes strict V11 dogfood, 68 focused release tests, 465 core tests, complete pre-freeze verification, the checker matrix, and independent review. Exact committed, hosted, canonical, fresh R2, closeout, and merge gates remain. `releaseReady: false`.
...
The product implementation remains integrated. Revision 60 remains retired after its consumed canonical failure. Revision 61 is retired after its unconsumed exact-candidate rehearsal timeout. Revision 62 is retired after its exact V11 identity failure. Revision 63 has passed focused, broad pre-freeze, checker, and independent review gates. No release approval exists until its frozen source passes exact lifecycle, full verification, non-consuming exact-candidate rehearsal, hosted CI, one-shot canonical gating, and fresh three-domain R2.
...
- Revision 63 restored V11 attribute identity, strict V11 dogfood, 68-test focused release pair, 465-test core suite, complete pre-freeze verifier, checker matrix, and independent review: `pass`.
...
- Target branch: `main`.
- Current state: Revision 63 focused, broad pre-freeze, checker, and independent review gates pass; exact source freeze is next.
...
Freeze and commit the exact Revision 63 bytes. Require copied lifecycle, full verification, non-consuming exact-candidate rehearsal, and the hosted matrix to pass before invoking the canonical gate exactly once. On `pass`, launch fresh source-bound R2 reviewers across all three domains, close the milestone and memory, and merge.

## User-Facing Overview

V12 provides a portable IDE run session with exact handoff verification, dependency routing, and integration-readiness evidence. Revision 63 keeps the corrected copied-gate bound while restoring the authenticated V11 source identity. Release remains pending exact immutable, hosted, canonical, fresh R2, and merge gates.
