...
V12 is not merge-ready. Candidate-addressed external evidence preserves every retired source and route. Revision 45 proved environment isolation but exposed repository-contained private scratch as the remaining ancestor fallback. Revision 46 externalizes that owned scratch root and retains 53/53 focused release passes. Frozen verification, one exact canonical gate, fresh R2, hosted CI, milestone closeout, and owner merge remain.
...
The product implementation remains integrated. Candidate-addressed evidence preserves Revision 40's gate and R2 outcomes plus every later pre-gate failure. Revision 46 is in verification with no release approval; its gate and review suites pass 53/53.
