...
V12 is not merge-ready. Candidate-addressed external evidence preserves every retired source and route. Revision 44 proved the explicit gate dependency supply, then exposed that gate-only authority crossing into the release-review parent. Revision 45 closes that process boundary and retains 53/53 focused release passes. Frozen verification, one exact canonical gate, fresh R2, hosted CI, milestone closeout, and owner merge remain.
...
The product implementation remains integrated. Candidate-addressed evidence preserves Revision 40's gate and R2 outcomes plus every later pre-gate failure. Revision 45 is in verification with no release approval; its gate and review suites pass 53/53.
