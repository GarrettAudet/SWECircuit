...
V12 is not merge-ready. Candidate-addressed external evidence records exact candidate state. Revision 65 commit `e1b2c38b3c794fc3d4d8a967a20305885baa8662` passed exact copied lifecycle and complete verification, then failed its non-consuming exact-candidate rehearsal on a 283-character four-level Windows path projection. Its one-shot gate was never invoked and the source is permanently retired. Revision 66 compacts the complete private scratch layout; 72/72 focused tests and every broad pre-freeze gate pass. Independent review found no additional source defect and keeps release blocked on the immutable exact-candidate rehearsal. Exact immutable, hosted, canonical, fresh R2, closeout, and merge gates remain. `releaseReady: false`.
...
Candidate-addressed external evidence preserves Revision 64 and Revision 65 outcomes. Revision 66 is in `redesign -> fix -> verify`: its complete compact private layout and four-level regression are integrated, 72/72 focused tests and every broad pre-freeze gate pass, and independent review found no additional source defect. Exact immutable verification is next.
...
- Target branch: `main`.
- Current state: Revision 65 is retired; Revision 66 focused and broad pre-freeze checks pass.
...
The external host still owns context delivery, runtime selection, spawning, isolation, persistence, integration effects, and merge. Revision 66 still must prove its corrected path under exact materialization, hosted portability, one-shot canonical isolation, and fresh three-domain review. Its fixed 64-character temp-root budget retains 24 characters of headroom, so future added nesting must update the regression. Automated model and effort assignment plus IDE-native spawning remain accepted post-V12 work, not V12 claims.

## Next Recommended Work

Freeze one exact Revision 66 commit, require copied lifecycle, complete verification, non-consuming rehearsal, and all seven hosted jobs, then clear independent review and invoke its canonical gate exactly once. On `pass`, launch fresh source-bound R2 reviewers, close milestone and memory, and merge.

## User-Facing Overview

V12 provides a portable IDE run session with exact handoff verification, dependency routing, and integration-readiness evidence. R65's exact rehearsal exposed the missing fourth scratch level. R66 compacts the full private layout without changing product or host boundaries; focused and broad pre-freeze gates pass. Release remains pending exact immutable, hosted, canonical, fresh R2, and merge gates.
...
The complete 72-test focused pair and every broad pre-freeze gate pass. Independent review found
no additional source defect and keeps release blocked on the immutable rehearsal. Release remains
pending exact immutable, hosted, canonical, fresh R2, and merge gates.
