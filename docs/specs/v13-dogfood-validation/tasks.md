...
- [ ] T003: Run the domain and UI specialists in the first dependency-safe wave.
...
- [ ] T004: Integrate root outputs and run the dependent application specialist.
...
- [ ] T005: Run automated and browser verification.
...
- [ ] T006: Run the independent application reviewer and route its outcome.
...
- [ ] T007: Verify complete V12 handoff fan-in and integration readiness.
...
- [ ] T008: Record dogfood performance, friction, memory, and completion review.
