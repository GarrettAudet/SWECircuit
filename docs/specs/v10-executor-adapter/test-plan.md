...
- The current parity correction passes the positive checker and all 49 isolated scenarios: 46 expected rejections and three expected acceptances. Fresh `npm.cmd run verify` passes 275 tests, deterministic V10 dogfood, package inspection, and the clean offline consumer. Exact-commit review and hosted CI remain.
