...
- [x] T002: Redesign and regenerate visual assets.
  Scope: `docs/assets/source/generate-readme-demo-gifs.py`, `docs/assets/tracerail-concept.png`, and supporting GIFs.
  Verification: Python compile, asset generation, and manual visual preview.
- [x] T003: Update README and asset docs.
  Scope: README visual section and `docs/assets/README.md`.
  Verification: README teaches `goal | module | gate | evidence | memory` before deeper module details.
