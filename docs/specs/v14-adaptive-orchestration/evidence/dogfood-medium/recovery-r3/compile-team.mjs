...
const SOURCE_DEFINITIONS = [
  {
    ...
    path: "docs/specs/v14-adaptive-orchestration/evidence/dogfood-medium/recovery-r3/goal.md",
    description: "Closed revision-3 recovery objective and acceptance criteria.",
  },
  {
    id: "context.predecessor",
    path: "docs/specs/v14-adaptive-orchestration/evidence/dogfood-medium/recovery-r3/predecessor.json",
    description: "Exact revision-2 fix route, review evidence, and lineage identities.",
  },
  {
  ...
  },
  {
    ...
    path: "docs/specs/v14-adaptive-orchestration/evidence/dogfood-medium/recovery-r2/handoffs/review-raw-attempt-2.json",
    description: "Verified revision-2 independent review FIX handoff.",
  },
...
async function buildRequest() {
  ...
  return {
    ...
    goal: {
      ...
      revision: 3,
      objective:
        "Rebuild context identity against the corrected candidate, re-verify the complete Impact Planner, and obtain a fresh independent review without changing application code.",
      integrationOwner: "codex.main",
      assumptions: [
        {
          id: "assumption.no-product-change",
          statement:
            "The revision-3 candidate is the exact current Impact Planner state reviewed in revision 2; recovery changes only package identity and verification.",
          rationale:
            "The revision-2 reviewer found no functional defect and required a fresh package bound to corrected graph bytes.",
        },
      ],
      unresolvedDecisions: [],
      acceptanceCriteria: [
