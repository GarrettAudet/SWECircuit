...
const R22_ROOT = "docs/specs/v12-ide-run-loop/evidence/implementation/release-correction-r22";
...
async function copyHostNpmCacheSupply(destination, source = RELEASE_GATE_TEST_HOOKS.hostNpmCache) {
