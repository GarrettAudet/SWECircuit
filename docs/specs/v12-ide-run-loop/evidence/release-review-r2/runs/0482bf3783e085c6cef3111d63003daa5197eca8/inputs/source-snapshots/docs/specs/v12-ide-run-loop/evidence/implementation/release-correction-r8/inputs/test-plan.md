...
Release-correction revisions 6 and 7, V11 trust-root revision 35, and the current full pre-freeze gate pass. The exact Candidate 2 canonical gate and independent R2 release review remain pending.
...
- Canonical evidence retention: legacy and candidate-addressed gate logs are versionable; unrelated logs remain ignored; wrapper/R2 paths are byte-equivalent.
