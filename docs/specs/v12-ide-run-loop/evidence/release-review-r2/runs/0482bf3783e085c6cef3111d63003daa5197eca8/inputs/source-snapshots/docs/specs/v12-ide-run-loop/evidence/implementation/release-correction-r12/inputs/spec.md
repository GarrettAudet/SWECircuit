...
Implementation complete on `codex/v12-ide-run-loop`; Candidate 5 is retired and Revision 12 must close its two exact-candidate reproducibility defects before independent R2 release review.
