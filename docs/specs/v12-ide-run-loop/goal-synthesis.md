...
V11.1 evaluated all 15 legal partitions under `exhaustive_partition_search_fixed_scheduler`.

- Serial baseline: 1 agent, projected makespan 26.
- Selected partition: 4 exact agents, projected makespan 15, peak concurrency 3, zero conflict pairs, and 3 dependency handoffs.
- Selection reason: lower `projectedMakespan`, `15 < 26`.
- Compilation: `sha256:662a7ca9303d3d347dbbe32835b3f2635b37f22ef8b051214a9e5924cb3f6415`.
- Package: `sha256:a119a349e0705f73c15ac3f2c8757e4964ecf16e4dc445bc2e62f8ba51691c87`.
- Approval-bound reconstruction: `pass`.

No provider, model, prompt, executor, credential, grant, or runtime profile entered the request.
