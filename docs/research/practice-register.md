...
| Public contract parity checks | accepted | V10 exact-candidate review and public-contract parity RCA | Bind security- and lifecycle-significant ADR claims to their intended paragraph or table row, then reject missing terms, contradictory positive claims, and misplaced Markdown with fixtures | Repeated green candidates drifted when canonical prose existed elsewhere in a section while the active summary remained incomplete or contradictory. |
