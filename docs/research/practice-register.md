...
| Rail Composition | accepted | LangChain composition model and PromptChainer research | Add `docs/framework/rail-composition.md` and `_rail-template.md` | Gives TraceRail one simple primitive for composing SWE workflows: input, module, gate, artifact, outcome. |
