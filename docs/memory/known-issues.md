...
| 2026-07-08 | V6 defines pack governance but has no pack installer. | Packs must be copied or adopted manually for now. | Pilot one official pack manually before adding tooling. | `docs/specs/v6-module-rail-catalog/` |
