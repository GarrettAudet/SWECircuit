...
| 2026-07-09 | Visual comprehension cannot be fully checker-validated. | README assets can exist, render, and still confuse first-time readers. | Use manual comprehension review; V8 makes the static concept visual the primary README asset and keeps generated GIFs as support. | `docs/specs/v8-readme-visual-clarity/`; `docs/assets/README.md` |
