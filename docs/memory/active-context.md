...
- GitHub `main` will not show V6 README changes, including the GIF, until V6 is merged after approval.
...
- A promised README visual should be a tracked asset and checker-enforced embed, not only a Mermaid block or chat plan.
