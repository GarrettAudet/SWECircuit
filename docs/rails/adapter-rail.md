...
| Module registry | Accepted or optional capability | Normalize the capability as a module, rail, adapter, or pack entry. | Discoverable registry entry | Contract and status are explicit. | `pass`, `clarify`, `learn` | Module registry |
